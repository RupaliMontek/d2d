...
function scrollFunction() {
  if (document.body.scrollTop > 50 || document.documentElement.scrollTop > 50) {
    document.getElementById("forTopHead").style.padding = "5px 0";
  } else {
    document.getElementById("forTopHead").style.padding = "20px 0";
  }
  if (document.body.scrollTop > 50 || document.documentElement.scrollTop > 50) {
  ...
  if (document.body.scrollTop > 50 || document.documentElement.scrollTop > 50) {
    document.getElementById("frmarquee").style.fontSize = "12px";
  } else {
    document.getElementById("frmarquee").style.fontSize = "15px";
  }
  if (document.body.scrollTop > 50 || document.documentElement.scrollTop > 50) {
    document.getElementById("frmarquee2").style.fontSize = "12px";
  } else {
    document.getElementById("frmarquee2").style.fontSize = "15px";
  }
}
</script>
  </body>
...
function select_sheet_type(type){
 ...
 function CheckedAll_import(){
     if ($('#ChkAll_import').is(':checked')) {
          ...
          $('#all_export input[type=checkbox]:checked').removeAttr('checked');
     }
   }
   
 function CheckedAll_Export(){
     if ($('#ChkAll_export').is(':checked')) {
          $('#all_export input[type=checkbox]').attr('checked', 'checked');           
     }
     else {
